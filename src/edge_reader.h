...
public:
	 ...
	 */
	virtual void filter(const char* edges_file, const ContigMap* contigs, const char* filtered_edges_file) = 0;
};
...
public:
	 ...
	 */
	void filter(const char* edges_file, const ContigMap* contigs, const char* filtered_edges_file);
};
